...
old = '''  net.save(out + "/policy.bin");
  norm.save(out + "/obs_norm.bin");
  Macro m;
'''
new = '''  if (!net.save(out + "/policy.bin") ||
      !norm.save(out + "/obs_norm.bin") ||
